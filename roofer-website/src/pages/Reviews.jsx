const reviews = [
  { name: 'Anna K.', location: 'Zielona Góra', text: 'Panowie z Roofer zrobili u nas dach od podstaw. Profesjonalna wycena, terminowość i porządek na budowie. Polecam każdemu!', rating: 5 },
  ...
  { name: 'Piotr L.', location: 'Czerwieńsk', text: 'Współpraca z Roofer to przyjemność. Doradzili, zaproponowali lepsze rozwiązanie, wyszło taniej niż zakładałem.', rating: 5 },
]
