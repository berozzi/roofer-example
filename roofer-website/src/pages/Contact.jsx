    ...
    <main className="pt-24 pb-16 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-wood-500 mb-12 max-w-lg">
          Masz pytanie? Chcesz wycenić dach? Napisz lub wpadnij do nas – doradzimy i pomożemy.
        </p>
        ...
        <div className="grid md:grid-cols-5 gap-10">
          <div className="md:col-span-2 space-y-6">
            <div className="bg-wood-50 border border-wood-100 rounded-2xl p-6">
              ...
              <div className="space-y-3 text-sm text-wood-600">
                <p><span className="font-semibold">Adres:</span> ul. Wojska Polskiego 100, 65-001 Zielona Góra</p>
                <p><span className="font-semibold">Telefon:</span> +48 123 456 789</p>
                <p><span className="font-semibold">E-mail:</span> kontakt@roofer.pl</p>
              </div>
            </div>
            ...
            <div className="bg-wood-50 border border-wood-100 rounded-2xl p-6">
              ...
              <div className="space-y-2 text-sm text-wood-600">
                <p><span className="font-semibold">Pn–Pt:</span> 7:00 – 17:00</p>
                <p><span className="font-semibold">Sobota:</span> 8:00 – 14:00</p>
            ...
            <div className="bg-wood-50 border border-wood-100 rounded-2xl p-6">
              ...
              <div className="bg-wood-200 h-40 rounded-lg flex items-center justify-center text-wood-400 text-sm">
                <a href="https://maps.google.com/?q=Wojska+Polskiego+100+Zielona+Góra" target="_blank" rel="noopener noreferrer" className="hover:text-wood-600 transition underline">
          ...
          <div className="md:col-span-3 bg-wood-50 border border-wood-100 rounded-2xl p-6 md:p-8">
